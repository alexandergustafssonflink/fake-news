...
// function getAuthor() {
//     if ($posts[]['authorId'] === $authors[0]['id']) {
//         echo $authors[]['name']; 
//     }
// } 

echo $posts[0]['authorId']; 